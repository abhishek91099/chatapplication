...
//  const Login=({ auth, toggleAuth }:ChatProps)=> {
...
//                 Login
//               </button>
//               <div className='flex'><h1  className='cursor-pointer hover:text-cyan-500' onClick={() => router.push('/register')}>New User Register</h1></div>
//             </div>
//           </form>
//         </div>
//       </div>
